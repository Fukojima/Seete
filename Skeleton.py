...
class bd:
    ...
    def __init__(self):
        ...
        Label(self.bdd, text="ETE - Jurandir Bezerra Lins").grid(row=6, column=1,sticky=E,
                                                                          padx=9, pady=9)
...
class main:
    ...
    def about_us(self):
        messagebox.showinfo("Sobre",
                            """Este software foi desenvolvido na linguagem de Python, por estudantes do curso técnico de Desenvolvimento de Sistemas no ETE-Jurandir Bezerra Lins.\nSeu objetivo é suprir a demanda de informações dos alunos sobre seus dados, notas,faltas entre outros.\nSeu fim é totalmente acadêmico. """)

    def cred(self):
        messagebox.showinfo("Créditos",
                            """Professores:\nMarcelo Araújo\nMarcone Araújo\nGuibson Santana(Coordenador)\nAlunos:\nCleiton Lucas\nEmerson Rodrigues\nLeonardo Fenix\nLucas Antonio""")
    ...
    def browser(self):
        import os, webbrowser
        from urllib.request import pathname2url
        url = 'file:{}'.format(pathname2url(os.path.abspath('Skeleton.html')))
        webbrowser.open(url)
    ...
    def __init__(self):
        ...
        self.root.title("7 - Sistema da Escola Técnica Estadual")
        ...
        Label(self.root, text="Sistema da Escola Técnica Estadual", font="Times,20", foreground='red4').grid(row=2,
                                                                                                             column=0,
                                                                                                             sticky=W + E,
                                                                                                             padx=40)
        Label(self.root, text="Jurandir Bezerra Lins", font="Times,20", foreground='red4').grid(row=3, column=0,
                                                                                                sticky=W + E, padx=40)
        ...
        self.help.add_command(label="Site", command=self.browser)
        ...
        self.help.add_separator()
        self.help.add_command(label="Créditos", command=self.cred)
